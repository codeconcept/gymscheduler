<script>
  const nbOfDays = [
    ...
    { id: 2, text: "Two days", value: 2 },
    { id: 3, text: "Three days", value: 3 },
    { id: 4, text: "Four day", value: 4 },
    { id: 5, text: "Five days", value: 5 },
    { id: 6, text: "Six days", value: 6 },
    { id: 7, text: "one day", value: 7 }
  ];
